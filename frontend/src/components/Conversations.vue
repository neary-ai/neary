    ...
    <div class="p-8 pt-[5.5rem] max-w-3xl ">
      ...
      <div v-else class="flex items-center justify-start max-w-lg">
        <div class="text-center py-12 px-14 mt-8 rounded-lg border-2 border-dashed border-neutral-100">
          <ChatBubbleLeftRightIcon class="mx-auto h-12 w-12 text-nearylight-300 mb-4" />
          ...
          <div class="mt-6">
            <Button @buttonClick="store.createConversation(store.selectedSpace ? store.selectedSpace.id : null)" button-type="btn-light">
